	...
	return (
			<div className="min-h-screen flex flex-col bg-white text-black">
				...
				<div className="max-w-5xl mx-auto px-4 flex flex-col items-center pt-10 md:pt-20">
						...
						<p className="text-lg md:text-xl mb-2 text-gray-700 text-center max-w-2xl">{t('aboutUsDescription')}</p>
					...
					<div className="max-w-5xl w-full flex flex-col gap-20 animate-fade-in">
						...
						<section className="flex flex-col md:flex-row items-center gap-10 md:gap-20">
							<div className="md:w-1/2 w-full order-2 md:order-1">
								<h2 className="text-2xl md:text-3xl font-bold mb-4">{t('aboutConnectHealthcare')}</h2>
								<p className="text-base md:text-lg text-gray-700 mb-4">
									{t('aboutPlatformDescription')}
								</p>
								<div className="flex gap-3 mt-4">
									<span className="bg-gray-100 text-gray-800 px-4 py-2 rounded-full font-semibold text-sm">{t('mission')}</span>
									<span className="bg-gray-100 text-gray-800 px-4 py-2 rounded-full font-semibold text-sm">{t('vision')}</span>
									<span className="bg-gray-100 text-gray-800 px-4 py-2 rounded-full font-semibold text-sm">{t('ourValue')}</span>
								</div>
							</div>
						...
						<section className="flex flex-col md:flex-row items-center gap-10 md:gap-20">
							...
							<div className="md:w-1/2 w-full">
								<h2 className="text-2xl md:text-3xl font-bold mb-4">{t('aboutVitalLook')}</h2>
									...
									<section className="w-full grid md:grid-cols-3 gap-8 bg-white rounded-2xl p-8">
										<div className="flex flex-col items-center text-center">
											<div className="w-16 h-16 mb-4 rounded-full bg-orange-50 flex items-center justify-center">
												<svg width="32" height="32" fill="none" viewBox="0 0 24 24"><path d="M12 4v16m8-8H4" stroke="#f97316" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"/></svg>
											</div>
										...
										<div className="flex flex-col items-center text-center">
											<div className="w-16 h-16 mb-4 rounded-full bg-orange-50 flex items-center justify-center">
												<svg width="32" height="32" fill="none" viewBox="0 0 24 24"><path d="M12 20V4m0 0l-7 7m7-7l7 7" stroke="#f97316" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"/></svg>
											</div>
										...
										<div className="flex flex-col items-center text-center">
											<div className="w-16 h-16 mb-4 rounded-full bg-orange-50 flex items-center justify-center">
												<svg width="32" height="32" fill="none" viewBox="0 0 24 24"><path d="M4 17v2a2 2 0 002 2h12a2 2 0 002-2v-2M7 9V7a5 5 0 0110 0v2" stroke="#f97316" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"/></svg>
											</div>
