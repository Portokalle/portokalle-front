...
import { verifyStripeSession, updateAppointmentStatus } from '@/infrastructure/http/stripeApiClient';
...
import { getDefaultPatientName, getDefaultStatus } from "@/shared/utils/userUtils";
